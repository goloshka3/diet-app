...
const FOODS = [
  ...
  // --- 肉・魚 ---
  { name: "鶏むね肉 皮なし（100g）", kcal: 105, protein: 23.3, fat: 1.9, satfat: 0.5, carb: 0.1, sugar: 0, fiber: 0, salt: 0.1, potassium: 370, calcium: 4, magnesium: 29, iron: 0.3, zinc: 0.7, vitA: 9, vitD: 0.1, vitB1: 0.10, vitB2: 0.11, vitB6: 0.64, vitB12: 0.2, folate: 13, vitC: 3 },
  { name: "鶏もも肉 皮なし（100g）", kcal: 113, protein: 19.0, fat: 5.0, satfat: 1.4, carb: 0, sugar: 0, fiber: 0, salt: 0.2, potassium: 320, calcium: 5, magnesium: 24, iron: 0.6, zinc: 1.8, vitA: 16, vitD: 0.2, vitB1: 0.12, vitB2: 0.19, vitB6: 0.31, vitB12: 0.3, folate: 10, vitC: 3 },
  ...
  { name: "牛もも肉（100g）", kcal: 196, protein: 19.5, fat: 13.3, satfat: 5.3, carb: 0.4, sugar: 0.4, fiber: 0, salt: 0.1, potassium: 330, calcium: 4, magnesium: 22, iron: 1.4, zinc: 4.5, vitA: 3, vitD: 0, vitB1: 0.08, vitB2: 0.20, vitB6: 0.32, vitB12: 1.2, folate: 9, vitC: 1 },
  { name: "鮭（1切れ 80g）", kcal: 99, protein: 17.8, fat: 3.3, satfat: 0.6, carb: 0.1, sugar: 0.1, fiber: 0, salt: 0.2, potassium: 280, calcium: 11, magnesium: 22, iron: 0.4, zinc: 0.4, vitA: 9, vitD: 26, vitB1: 0.12, vitB2: 0.17, vitB6: 0.51, vitB12: 4.7, folate: 16, vitC: 1 },
  { name: "さば（1切れ 80g）", kcal: 169, protein: 16.5, fat: 13.4, satfat: 3.7, carb: 0.2, sugar: 0.2, fiber: 0, salt: 0.2, potassium: 264, calcium: 5, magnesium: 24, iron: 1.0, zinc: 0.9, vitA: 30, vitD: 4.1, vitB1: 0.17, vitB2: 0.25, vitB6: 0.47, vitB12: 10.4, folate: 9, vitC: 1 },
  { name: "ツナ缶 水煮（1缶 70g）", kcal: 49, protein: 11.2, fat: 0.5, satfat: 0.1, carb: 0.1, sugar: 0.1, fiber: 0, salt: 0.4, potassium: 161, calcium: 4, magnesium: 18, iron: 0.4, zinc: 0.5, vitA: 7, vitD: 2.1, vitB1: 0.01, vitB2: 0.03, vitB6: 0.18, vitB12: 0.8, folate: 3, vitC: 0 },
  { name: "あさり むき身（40g）", kcal: 12, protein: 2.3, fat: 0.3, satfat: 0.1, carb: 0.2, sugar: 0.2, fiber: 0, salt: 0.8, potassium: 56, calcium: 26, magnesium: 37, iron: 0.9, zinc: 0.4, vitA: 1, vitD: 0, vitB1: 0, vitB2: 0.06, vitB6: 0.01, vitB12: 18, folate: 4, vitC: 0 },

  // --- 卵・大豆・乳 ---
  { name: "卵（1個 50g）", kcal: 71, protein: 6.1, fat: 5.1, satfat: 1.6, carb: 0.2, sugar: 0.2, fiber: 0, salt: 0.2, potassium: 65, calcium: 23, magnesium: 5, iron: 0.8, zinc: 0.6, vitA: 105, vitD: 1.9, vitB1: 0.03, vitB2: 0.19, vitB6: 0.05, vitB12: 0.6, folate: 25, vitC: 0 },
  { name: "木綿豆腐（1/2丁 150g）", kcal: 110, protein: 10.5, fat: 7.4, satfat: 1.2, carb: 2.3, sugar: 0.6, fiber: 1.7, salt: 0, potassium: 165, calcium: 140, magnesium: 86, iron: 2.3, zinc: 0.9, vitA: 0, vitD: 0, vitB1: 0.14, vitB2: 0.06, vitB6: 0.08, vitB12: 0, folate: 18, vitC: 0 },
  { name: "納豆（1パック 45g）", kcal: 83, protein: 7.4, fat: 4.5, satfat: 0.7, carb: 5.4, sugar: 1.2, fiber: 4.3, salt: 0, potassium: 297, calcium: 41, magnesium: 45, iron: 1.5, zinc: 0.9, vitA: 0, vitD: 0, vitB1: 0.03, vitB2: 0.25, vitB6: 0.11, vitB12: 0, folate: 54, vitC: 0 },
  { name: "厚揚げ（1/2枚 100g）", kcal: 143, protein: 10.7, fat: 11.3, satfat: 1.7, carb: 0.9, sugar: 0.1, fiber: 0.8, salt: 0, potassium: 120, calcium: 240, magnesium: 51, iron: 2.6, zinc: 1.1, vitA: 0, vitD: 0, vitB1: 0.07, vitB2: 0.03, vitB6: 0.08, vitB12: 0, folate: 28, vitC: 0 },
  { name: "牛乳（コップ1杯 200g）", kcal: 122, protein: 6.6, fat: 7.6, satfat: 4.7, carb: 9.6, sugar: 9.6, fiber: 0, salt: 0.2, potassium: 300, calcium: 220, magnesium: 20, iron: 0, zinc: 0.8, vitA: 76, vitD: 0.6, vitB1: 0.08, vitB2: 0.30, vitB6: 0.06, vitB12: 0.6, folate: 10, vitC: 2 },
